export enum ACTIONS_TYPE {
    ...
    SET_START_VALUE = 'CHANGE_START_VALUE/MODAL_WINDOW_COMPONENT',
    SET_FINISH_VALUE = 'CHANGE_FINISH_VALUE/MODAL_WINDOW_COMPONENT',
    SET_CONDITION_OF_WORK = 'CHANGE_CONDITION_OF_WORK/MODAL_WINDOW_COMPONENT',
    SET_AUTOPLAY_OPTION = 'SET_AUTOPLAY_OPTION/MODAL_WINDOW_COMPONENT',
}
